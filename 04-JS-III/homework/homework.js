...
function todosIguales(arreglo) {
  ...
  for( var i = 0; i < arreglo.length; i++){
    for( var y = i + 1; y < arreglo.length; y++){
...
function mesesDelAño(array) {
  ...
  for(var i = 0; i < array.length; i++){
    ...
    mesesRobados.push(array[i]);
    }
}
if(mesesRobados.length === 3){
  return mesesRobados;
}else{
...
function mayorACien(array) {
  ...
  for(var i = 0; i < array.length; i++){
    if(array[i] > 100){
    numerosRobados.push(array[i]);
    }
}
  return numerosRobados;
}
